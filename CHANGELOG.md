...
- Improved changelog promotion during version bumps so Unreleased notes are moved into the generated release section.
- Updated release, GitHub, AnkiWeb, project-structure, and AI assistant docs to reflect the current release automation and generated artifacts.

## 0.2.0 - 2026-06-30

- Rename add-on to Quick Search Browser.
