...
- `tools/release_check.py`: runs release checks and writes checksums plus release metadata.
...
- `tools/create_release.py`: automates version bump, release prep, GitHub release notes, commit, tag, optional push, and optional GitHub release publishing.
...
- `.github/workflows/release.yml`: GitHub release artifact build for pushed version tags.
